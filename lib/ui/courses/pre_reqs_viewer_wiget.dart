        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Text(
                'Added Pre-Requites (${ref.watch(preReqsEditingProvider).selectedPreReqs?.length.toString()})',
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
              ' (${ref.watch(preReqsEditingProvider).availablePreReqs.length.toString()})',
